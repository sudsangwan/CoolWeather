...
public class WeatherContract {
    ...
    //CONTENT_AUTHORITY is the name for entire Content Provider.
    public static final String CONTENT_AUTHORITY = "com.example.manuchaudhary.coolweather";

    //USE CONTENT_AUTHORITY to use as base of all Uris
