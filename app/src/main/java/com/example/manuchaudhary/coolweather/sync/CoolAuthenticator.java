...
/**
 * Manages "Authentication" to CoolWeather's backend service.  The SyncAdapter framework
 ...
 */
public class CoolAuthenticator extends AbstractAccountAuthenticator {

    public CoolAuthenticator(Context context) {
        super(context);
    }
