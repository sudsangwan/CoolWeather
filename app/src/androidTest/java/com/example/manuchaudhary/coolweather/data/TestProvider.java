...
import com.example.manuchaudhary.coolweather.data.WeatherContract.LocationEntry;
import com.example.manuchaudhary.coolweather.data.WeatherContract.WeatherEntry;

/*
    Note: This is not a complete set of tests of the CoolWeather ContentProvider, but it does test
...
public class TestProvider extends AndroidTestCase {
    ...
    public void testGetType() {
        ...
        long testDate = 1456419720; // Feb 25th, 2016
        // content://com.example.android.sunshine.app/weather/94074/20162502
        type = mContext.getContentResolver().getType(
                WeatherEntry.buildWeatherLocationWithDate(testLocation, testDate));
        // vnd.android.cursor.item/com.example.android.sunshine.app/weather/1456419720
